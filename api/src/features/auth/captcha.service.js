...
// Simple server-verified math captcha ("4 + 2 = ?"). The question is generated
// here and only the id travels to the client, so the answer can't be scraped
// from the page. Entries are single-use and expire after 5 minutes.
...
export function createCaptcha() {
  ...
  store.set(captchaId, { answer: a + b, expiresAt: now + TTL_MS });
